  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#060F0E] relative">
      ...
      <div className="text-center space-y-5 z-10 mt-20 w-full">
        ...
        <button className="font-bold text-black bg-[#E6FF79] px-4 py-2 hover:bg-transparent hover:text-[#E6FF79] border-1 border-[#E6FF79] rounded-md transition-all duration-200 ease-in-out mt-2">
          Get Started
        </button>
